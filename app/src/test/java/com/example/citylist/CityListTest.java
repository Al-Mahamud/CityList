...
public class CityListTest {
    ...
    {
        CityList cityList=new CityList();
        City city=new City("banasree","Dhaka");
        City city1=new City("fulbaria","Khulna");
        cityList.add(city);
        cityList.add(city1);
    ...
    @Test
    public void testDeleteExecption()
    {
        CityList cityList=new CityList();
        City city=new City("banasree","Dhaka");
        City city1=new City("fulbaria","Khulna");
    ...
    public void testSort() {
        ...
        assertEquals(0, mockCity().compareTo(cityList.getCities(2).get(0)));
    }
}
